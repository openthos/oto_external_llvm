...
ifeq (libLLVM60, $(filter libLLVM60,$(LOCAL_SHARED_LIBRARIES)$(LOCAL_SHARED_LIBRARIES_$(HOST_OS))))
# Skip building a 32-bit shared object if they are using libLLVM60.
...
$(hide) $(LLVM60_TBLGEN) \
	-I $(dir $<)	\
	-I $(LLVM60_ROOT_PATH)/include	\
	-I $(LLVM60_ROOT_PATH)/host/include	\
	-I $(LLVM60_ROOT_PATH)/lib/Target	\
